...
class User(db.Model):
    ...
    def followed_posts(self):
        '''It is always a good idea to return query objects instead of results, because that gives the caller the
        choice of adding more clauses to the query before it is executed.
        (e.g. count() triggers query execution and returns number of results,
        first() returns the first result, while all() returns array of all results) '''
